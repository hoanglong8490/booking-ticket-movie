...
export default function Footer(props) {
    ...
    return (
        <footer className="py-6 bg-dark dark:text-gray-900 text-white ">
            <div className="container px-6 mx-auto space-y-6 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-5">
                <div className="grid grid-cols-12">
                    <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                        <a rel="noopener noreferrer" href="/123" className="flex justify-center space-x-3 md:justify-start">
                        ...
                        <div className='grid grid-cols-3' style={{ color: '#fff' }}>
                            {arrHeThongRap.map((htr, index) => {
                                return <div key={index}>
                                    <img src={htr.logo} alt={htr.logo} className='w-14'></img>
                                </div>
                            })}
                        </div>
                    </div>
                    <div className="col-span-6 text-center md:text-left md:col-span-3">
                        <p className="pb-1 text-lg font-medium">Các nhà đầu tư khác </p>
                        <ul>
                            <li>
                                <a rel="noopener noreferrer" href="/" className="hover:dark:text-violet-600">FaceBook</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="/" className="hover:dark:text-violet-600">Twitch</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="/" className="hover:dark:text-violet-600">Instagram</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="/" className="hover:dark:text-violet-600">Youtube</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="/" className="hover:dark:text-violet-600">Google</a>
                            </li>
                        </ul>
                    </div>
                </div>
